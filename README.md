...
**Registration Form** is a signup page showcasing my knowledge of HTML forms. The main object of this project is to implement and showcase my knowledge of controling what types of data people can type into a form, and some new CSS tools for styling a page.


## 🛠 Built With 
**Registration Form** is built with a combination of HTML and CSS languages.
